...
class SubjectSkillRatingApi {

    public static let sharedInstance = SubjectSkillRatingApi()
    
    
//MARK:- Assign Subject to class Api
func SubmitApiList(url : String,parameters: [String : Any]?,completionResponse:  @escaping (SubjectSkillRatingModel) -> Void,completionnilResponse:  @escaping (String?) -> Void,complitionError: @escaping (String?) -> Void){
...
private func SubmitApiJSON(data: [String : Any],completionResponse:  @escaping (SubjectSkillRatingModel) -> Void,completionError: @escaping (String?) -> Void)  {
    
    let assignSubjetcToClassData = SubjectSkillRatingModel(JSON: data)
