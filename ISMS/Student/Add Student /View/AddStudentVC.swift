...
extension AddStudentVC : ViewDelegate{
    ...
    func setupUI(){
        ...
        txtFieldRollnoOrAddmissionId.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kRollNoOrAdmissionId)
        //        txtFieldIdProof.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kIdProof)
        txtFieldClassDropDown.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kSelectClass)
        
        txtParentFirstName.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kFirstName)
        txtParentLastName.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kLastName)
        txtParentRelation.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kRelation)
        txtParentDOB.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kDOB)
        txtParentEmail.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kEmail)
        txtParentPhoneNo.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kPhoneNumber)
        txtParentOthers.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kOthers)
        textFieldIDProof.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kIdProof)
        txtparentAddress.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kAddress)
        txtFieldStudentIdProof.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kIdProof)
        txtFieldDepartment.SetTextFont(textSize: KTextSize.KSixteen, placeholderText: KPlaceholder.kSelectDepartment)
