...
class AddStudentRatingApi {
    ...
    func GetAddSkillList(url : String,parameters: [String : Any]?,completionResponse:  @escaping (AddStudentRatingListModel) -> Void,completionnilResponse:  @escaping (String?) -> Void,complitionError: @escaping (String?) -> Void){
    ...
    func GetAddOccrance(url : String,parameters: [String : Any]?,completionResponse:  @escaping (AddSubjectModel) -> Void,completionnilResponse:  @escaping (String?) -> Void,complitionError: @escaping (String?) -> Void){
        ...
        Alamofire.request(urlCmplete, method: .post, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { (response) in
            ...
            if response.result.isSuccess{
                ...
                if let responseData  = data as? [String : Any]{
                    print("your Subject list rating responsedd : \(responseData)")
                    self.GetAddOccranceJSON(data: responseData, completionResponse: { (response) in
                        completionResponse(response)
                    }, completionError: { (error) in
                        complitionError(error)
                    })
    ...
    private func GetAddOccranceJSON(data: [String : Any],completionResponse:  @escaping (AddSubjectModel) -> Void,completionError: @escaping (String?) -> Void)  {
        
        let assignSubjetcToClassData = AddSubjectModel(JSON: data)
    ...
    private func StudentsByClassIdJSON(data: [String : Any],completionResponse:  @escaping (GetStudentsByClassIdModel) -> Void,completionError: @escaping (String?) -> Void)  {
        
        let StudentsByClassId = GetStudentsByClassIdModel(JSON: data)
        
        if StudentsByClassId != nil{
            completionResponse(StudentsByClassId!)
        }else{
            completionError(Alerts.kMapperModelError)
        }
    }
    
    func StudentsByClassIdApi(url : String,parameters: [String : Any]?,completionResponse:  @escaping (GetStudentsByClassIdModel) -> Void,completionnilResponse:  @escaping (String?) -> Void,complitionError: @escaping (String?) -> Void){
    ...
    if let responseData  = data as? [String : Any]{
    print("your Subject list rating responsedd : \(responseData)")
    self.StudentsByClassIdJSON(data: responseData, completionResponse: { (response) in
    completionResponse(response)
    }, completionError: { (error) in
    complitionError(error)
    })
