...
class TeacherSubjectSkillRatingApi {
    
    public static let sharedInstance = TeacherSubjectSkillRatingApi()
    
    
    //MARK:- Assign Subject to class Api
    func SubmitApiList(url : String,parameters: [String : Any]?,completionResponse:  @escaping (TeacherSubjectSkillRatingModel) -> Void,completionnilResponse:  @escaping (String?) -> Void,complitionError: @escaping (String?) -> Void){
    ...
    private func SubmitApiJSON(data: [String : Any],completionResponse:  @escaping (TeacherSubjectSkillRatingModel) -> Void,completionError: @escaping (String?) -> Void)  {
        
        let assignSubjetcToClassData = TeacherSubjectSkillRatingModel(JSON: data)
